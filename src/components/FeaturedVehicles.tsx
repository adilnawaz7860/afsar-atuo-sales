...
export default function FeaturedVehicles({ currentLanguage, currentTheme, setActiveTab }: FeaturedVehiclesProps) {
  ...
  {selectedBranch === 'showroom'
    ? (currentLanguage === 'en'
        ? 'AFSAR Auto Sales - Mahanagar'
        : 'अफसर ऑटो सेल्स - महानगर')
    : (currentLanguage === 'en'
        ? 'Lucknow Stock Yard Depot'
        : 'लखनऊ स्टॉक यार्ड डिपो')
  }
</h4>
...
<p className="text-xs text-slate-350 max-w-sm mx-auto leading-relaxed">
  {selectedBranch === 'showroom'
    ? (currentLanguage === 'en'
        ? 'G-73, Karamat Market, Mahanagar, Lucknow, Uttar Pradesh 226006. Open today till 7:00 PM.'
        : 'जी-73, करामत मार्केट, महानगर, लखनऊ, उत्तर प्रदेश 226006। आज शाम 7:00 बजे तक खुला है।')
    : (currentLanguage === 'en'
        ? 'Deva Road Industrial Block. Direct heavy loading bay entrance.'
        : 'देवा रोड इंडस्ट्रियल ब्लॉक। सीधा भारी लोडिंग बे प्रवेश द्वार।')
  }
</p>
              </div>
              ...
              <div className="relative z-10 flex flex-wrap gap-2 justify-between items-center border-t border-slate-800 pt-4">
                ...
                <a
                  href={`https://wa.me/918318914223?text=${encodeURIComponent(
                    currentLanguage === 'en' 
